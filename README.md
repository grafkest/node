...
1. Откройте интегрированный терминал (горячая клавиша `Ctrl`+`` ` `` или меню **Terminal → New Terminal**). Терминал автоматически окажется в корне проекта.
...
3. Для локального тестирования интерфейса выполните команду разработки:
...
4. Чтобы собрать production-версию, используйте меню **Terminal → Run Task…**, выберите задачу `npm: build` или запустите команду вручную:
...
5. Для проверки собранной версии локально выполните:
...
6. По желанию запустите линтер перед коммитом:
